...
const NEW_FEATURE = "Invoices & Billing History";

async function updateBillingFeatures() {
    console.log("Starting billing features update...");
    try {
        ...
        for (const document of querySnapshot.docs) {
            ...
            const exists = features.some(f =>
                f.toLowerCase().includes("invoices") || f.toLowerCase().includes("billing history")
            );
