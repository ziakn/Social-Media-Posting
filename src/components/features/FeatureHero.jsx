        ...
        <div className="relative overflow-hidden pt-32 pb-20 lg:pt-40 lg:pb-28 font-sans">
            ...
            <div className="container mx-auto px-6 max-w-7xl relative z-10">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    {/* Heading */}
                    <h1 className="text-4xl lg:text-[3.8rem] font-[650] tracking-[-0.03em] leading-[1.1] text-[#2d253b] mb-6">
                        Everything you need to <span className="bg-gradient-to-br from-[#5e4a7a] to-[#3a2e4a] bg-clip-text text-transparent font-bold">grow</span> your social presence.
                    </h1>

                    {/* Description */}
                    <p className="text-xl text-[#4a3d58] max-w-3xl mx-auto font-[420] leading-relaxed">
                        From AI-powered content creation to clear analytics, UNI.social gives you the tools to grow faster and smarter.
                    </p>
                </div>
            </div>
        </div>
