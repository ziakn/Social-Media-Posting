        ...
        <section className="py-32 bg-slate-50 border-y border-slate-100 font-inter">
            <div className="container mx-auto px-6 max-w-[1280px]">
                <div className="flex flex-col md:flex-row justify-between items-center mb-24 gap-8">
                    <div className="space-y-4 text-center md:text-left">
                        <h2 className="text-4xl md:text-5xl font-extrabold text-[#0C1B33] font-plus-jakarta tracking-tight leading-tight uppercase">
                            Protocol <span className="text-[#00A2FF]">Intelligence</span>
                        </h2>
                ...
                <div className="grid md:grid-cols-3 gap-10">
                    {posts.map((post, i) => (
                        <div key={i} className="group bg-white border border-slate-200 rounded-[10px] overflow-hidden hover:border-[#00A2FF]/30 transition-all hover:shadow-subtle flex flex-col h-full">
                            ...
                            <div className="p-8 flex flex-col flex-1 space-y-6">
                                <h3 className="text-xl font-extrabold text-[#0C1B33] font-plus-jakarta uppercase tracking-tight group-hover:text-[#00A2FF] transition-colors line-clamp-2 leading-tight">
                                    {post.title}
                                </h3>
                                <div className="pt-4 border-t border-slate-50 flex items-center justify-between mt-auto">
                                    ...
                                    <Link href={`/blog/${post.slug}`} className="text-[#0C1B33] hover:text-[#00A2FF] transition-colors">
