            ...
            <div className="container mx-auto px-6 max-w-[1280px]">
                <div className="text-center mb-24 space-y-6">
                    <h2 className="text-4xl md:text-5xl font-extrabold text-[#0C1B33] font-plus-jakarta tracking-tight uppercase">
                        Powerful Features <br /> to <span className="text-[#00A2FF]">Scale</span> Your Social Media
                    </h2>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {coreFeatures.map((f, i) => (
                        <div key={i} className="p-10 rounded-[10px] bg-white border border-slate-100 hover:border-[#00A2FF]/30 shadow-sm hover:shadow-subtle hover:-translate-y-2 transition-all duration-500 flex flex-col group relative overflow-hidden">
                            <div className="absolute top-0 right-0 w-24 h-24 bg-slate-50 rounded-bl-[100px] -mr-8 -mt-8 group-hover:bg-[#00A2FF]/5 transition-colors" />
                            ...
                            <div className="pt-8 border-t border-slate-50 flex items-center gap-2 text-[10px] font-black uppercase text-[#00A2FF] tracking-[0.2em] font-plus-jakarta relative z-10">
