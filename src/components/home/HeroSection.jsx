...
export default function HeroSection() {
    return (
        <section className="relative pt-32 pb-24 md:pt-48 md:pb-40 bg-white overflow-hidden">
            <div className="container mx-auto px-6 max-w-[1280px] flex flex-col lg:flex-row items-center gap-20 relative z-10">
                <div className="flex-1 space-y-8 text-center lg:text-left">
                    ...
                    <h1 className="text-5xl md:text-7xl font-extrabold text-[#0C1B33] tracking-tighter leading-[0.9] font-plus-jakarta uppercase">
                        The Ultimate <span className="text-[#00A2FF]">Multi-Platform</span> Social Media Scheduler
                    </h1>
                        ...
                        <div className="bg-white rounded-[10px] h-[400px] md:h-[500px] overflow-hidden border border-slate-100 relative">
                            ...
                            <div className="absolute inset-x-0 top-1/2 -translate-y-1/2 flex justify-center">
                                <div className="bg-white p-8 rounded-xl shadow-2xl border border-slate-100 animate-in fade-in zoom-in duration-700 max-w-[320px] relative overflow-hidden">
                                    <div className="absolute top-0 right-0 w-24 h-24 bg-[#00A2FF]/5 blur-3xl pointer-events-none" />
                                    <div className="flex items-center gap-3 mb-6">
                                        ...
                                        <div>
                                            ...
                                            <span className="text-[10px] font-bold text-[#00A2FF] uppercase tracking-widest font-plus-jakarta">Optimizing Peak Times</span>
                                        </div>
                                    </div>
                                    ...
                                    <button className="mt-8 w-full py-3 bg-[#00A2FF] text-white text-[10px] font-black uppercase tracking-[0.2em] rounded-lg shadow-lg shadow-[#00A2FF]/20 font-plus-jakarta">Publishing Intelligence...</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div className="absolute top-0 right-0 w-1/3 h-full bg-gradient-to-l from-[#00A2FF]/5 to-transparent pointer-events-none" />
