...
import {
    ...
    Edit, Trash2, Send, Loader2, BarChart3, Pin
} from "lucide-react";

// Server Actions
import {
    deletePinterestPost, getPinterestAccounts
...
export default function PinterestPosts({ accountId: initialAccountId }) {
    ...
    return (
        <div className="p-8 max-w-7xl mx-auto space-y-8">
            ...
            <div className="relative overflow-hidden rounded-2xl bg-white border border-gray-100 shadow-lg shadow-red-50/20 p-5 lg:p-6">
                <div className="absolute top-0 right-0 -translate-y-1/2 translate-x-1/4 w-64 h-64 bg-gradient-to-br from-red-100/10 to-red-400/10 rounded-full blur-2xl pointer-events-none" />

                <div className="relative flex flex-col md:flex-row items-center justify-between gap-6">
                    <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-2">
                        <div className="inline-flex items-center gap-2 px-2.5 py-0.5 rounded-full bg-[#E60023] border border-red-700 text-white">
                            <PinterestLogo className="h-3 w-3 fill-white" />
                            <span className="text-[9px] font-black uppercase tracking-wider">Pinterest Content Studio</span>
                        </div>
                        ...
                        <div className="space-y-0.5">
                            ...
                            <p className="text-gray-500 max-w-md text-xs font-medium leading-relaxed">
                                Curate and schedule your visual masterpieces with precision and intelligence.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        >
                            <div className="relative flex items-center gap-2">
                                ...
                                <span className="text-sm">Create Masterpiece</span>
                            </div>
                        </Button>
                    </div>
                </div>
                    ...
                    {isCreating && (
                        <div className="bg-white w-full h-full rounded-2xl overflow-hidden shadow-2xl flex flex-col">
                            <div className="px-6 py-4 bg-white border-b border-gray-50 flex items-center justify-between font-sans shrink-0">
                                <div className="flex items-center gap-4">
                                    <div className="w-8 h-8 bg-[#E60023] rounded-xl shadow-lg flex items-center justify-center transform rotate-3"><PinterestLogo className="h-4 w-4 fill-white" /></div>
                                    <div className="flex flex-col">
                                        <h2 className="text-sm font-black text-gray-900 leading-none">Pin Creator</h2>
                                        <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mt-1">Pinterest Studio v1.0</span>
                                    </div>
                                </div>
