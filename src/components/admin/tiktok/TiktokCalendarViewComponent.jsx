...
import TiktokFullCalendar from "./TiktokFullCalendar";
import { getAllTiktokCalendarPosts } from "@/app/actions/social/tiktok/tiktokPostsActions";
import { getUserTikTokAccounts } from "@/app/actions/social/tiktok/getAccounts";

export default function TiktokCalendarViewComponent({
    onDateClick,
    onPostClick,
    onRefresh,
    refreshTrigger = 0
    ...
    useEffect(() => {
        // Fetch accounts once
        getUserTikTokAccounts().then(res => {
            ...
            {loadingCalendar && (
                <div className="absolute inset-0 z-10 bg-white/80 flex items-center justify-center backdrop-blur-sm">
                    <div className="flex flex-col items-center gap-3">
                        <div className="h-8 w-8 animate-spin rounded-full border-4 border-gray-100 border-t-black" />
