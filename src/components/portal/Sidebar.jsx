...
export function AppSidebar({ user, ...props }) {
  ...
  const coreNavItems = [
    ...
    {
      title: "Media Library",
      url: ROUTES.PORTAL_GALLERY,
      icon: ImageIcon,
      permission: "view_gallery",
    },
    {
      title: "Accounts",
      url: ROUTES.PORTAL_SOCIAL_CONNECT,
      icon: Link2,
  ...
  // Group D: System (System/Management)
  const systemNavItems = [
    {
      title: "Users",
      url: ROUTES.PORTAL_USER,
      icon: UserCog,
      permission: "view_users",
    },
    {
      title: "Roles",
      url: ROUTES.PORTAL_ROLE,
      icon: Shield,
      permission: "view_roles",
    },
    {
      title: "Permissions",
      url: ROUTES.PORTAL_PERMISSION,
      icon: Lock,
      permission: "view_permissions",
    },
    {
      title: "Integrations",
      url: ROUTES.PORTAL_PLATFORMS,
      icon: Globe,
