...
// Internal Components
import TwitterCalendarViewComponent from "@/components/portal/twitter/TwitterCalendarViewComponent";
import TwitterViewComponent from "@/components/portal/twitter/TwitterViewComponent";
import TwitterListingViewComponent from "@/components/portal/twitter/TwitterListingViewComponent";
import TwitterPreview from "@/components/portal/twitter/TwitterPreview";
import TwitterAnalyticsModal from "@/components/portal/twitter/TwitterAnalyticsModal";
    ...
    return (
        <div className="w-full h-full flex flex-col bg-gray-50 overflow-hidden">
            ...
            <GalleryModal
                ...
                maxSelection={postType === 'video' ? 1 : 4}
            />
        </div>
    );
}
