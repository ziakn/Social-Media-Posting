...
import { publishBlueSkyPostNow } from "@/app/actions/social/bluesky/blueskyPostsActions";
import { toast } from "sonner";
import { BlueSkyLogo } from "@/components/icons/BlueSkyLogo";
import BlueSkyPreview from "./BlueSkyPreview";


export default function BlueSkyFullCalendar({
    posts = [],
    accounts = [],
    onDateClick,
    onPostClick,
                ...
                <div className="flex flex-col">
                    ...
                    {!mini && (
                        <p className="text-gray-500 text-sm mt-1">
                            Plan and manage your BlueSky content
                        </p>
                    )}
                </div>
                                                    ...
                                                    <div className={cn("relative flex-shrink-0 rounded-md overflow-hidden bg-gray-100 border border-gray-200", mini ? "w-4 h-4" : "w-7 h-7")}>
                                                        {mediaUrl ? (
                                                            ...
                                                            <div className="w-full h-full flex items-center justify-center bg-gray-50">
                                                                <BlueSkyLogo className="h-4 w-4 text-black" />
                                                            </div>
                                                        )}
                                                        {isProcessing && (
                                                ...
                                                <div className="flex">
                                                    ...
                                                    <div className="w-[320px] flex-shrink-0 bg-gray-50/50 p-4 border-r border-gray-100/50">
                                                        <BlueSkyPreview
                                                            ...
                                                            page={accounts.find(a => a.accountId === post.accountId) || { pageName: post.username || "BlueSky" }}
                                                            compact={true}
                                                            hideLogo={true}
                                                            noBorder={true}
                                                        />
                                                            ...
                                                            <>
                                                                ...
                                                                >
                                                                    ...
                                                                    <div className="flex flex-col">
                                                                        ...
                                                                        <span className="text-[10px] text-gray-400 font-medium">Open on BlueSky</span>
                                                                    </div>
                                                                </DropdownMenuItem>
                                                            </>
                                                        ) : (
