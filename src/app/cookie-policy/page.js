                ...
                <div className="max-w-4xl mb-20 space-y-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <h1 className="text-4xl md:text-7xl font-extrabold text-[#0C1B33] tracking-tighter leading-[0.9] font-plus-jakarta uppercase">
                            Cookie <br /> <span className="text-[#00A2FF]">Policy.</span>
                        </h1>
                    </div>
                ...
                <div className="grid lg:grid-cols-12 gap-20">
                    <div className="lg:col-span-8 space-y-16">
                        {cookieTypes.map((type, i) => (
                            <section key={i} className="p-10 border border-[#E1E7EF] rounded-[10px] space-y-6 relative overflow-hidden group hover:border-[#00A2FF] transition-all">
