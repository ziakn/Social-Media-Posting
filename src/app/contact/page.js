        ...
        <div className="bg-white pt-32 pb-24 font-plus-jakarta text-[#3E4652]">
            <div className="container mx-auto px-6 max-w-[1200px]">
                ...
                <div className="max-w-4xl mx-auto text-center mb-20 space-y-6">
                    <Badge className="bg-slate-50 text-[#00A2FF] border-[#E1E7EF] uppercase tracking-[0.2em] text-[10px] px-4 py-1.5 font-black">Authorized Support</Badge>
                    <h1 className="text-5xl md:text-7xl font-extrabold text-[#0C1B33] tracking-tighter leading-none font-plus-jakarta uppercase">
                        Let's <span className="text-[#00A2FF]">Connect.</span>
                    </h1>
                ...
                <div className="grid lg:grid-cols-2 gap-20 items-start">
                    ...
                    <div className="bg-white border border-[#E1E7EF] p-10 md:p-12 rounded-[10px] space-y-10 shadow-2xl shadow-slate-200/50 relative overflow-hidden">
                        <div className="absolute top-0 right-0 w-1/4 h-full bg-[#00A2FF]/5 blur-[100px] pointer-events-none" />
                        ...
                        <form className="space-y-6 relative z-10" onSubmit={(e) => e.preventDefault()}>
                            <div className="grid md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <input placeholder="John Doe" className="w-full h-14 rounded-[8px] border border-[#E1E7EF] bg-[#F5F8FB] px-6 font-bold text-[#0C1B33] focus:bg-white focus:ring-1 focus:ring-[#00A2FF] outline-none" />
                                </div>
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Business Email</label>
                                    <input type="email" placeholder="john@company.com" className="w-full h-14 rounded-[8px] border border-[#E1E7EF] bg-[#F5F8FB] px-6 font-bold text-[#0C1B33] focus:bg-white focus:ring-1 focus:ring-[#00A2FF] outline-none" />
                                </div>
                            </div>
                            <div className="space-y-2">
                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Subject</label>
                                <input placeholder="Inquiry about Enterprise API Access" className="w-full h-14 rounded-[8px] border border-[#E1E7EF] bg-[#F5F8FB] px-6 font-bold text-[#0C1B33] focus:bg-white focus:ring-1 focus:ring-[#00A2FF] outline-none" />
                            </div>
                            <div className="space-y-2">
                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Message</label>
                                <textarea placeholder="Outline your requirements..." className="w-full min-h-[160px] rounded-[8px] border border-[#E1E7EF] bg-[#F5F8FB] p-6 font-bold text-[#0C1B33] focus:bg-white focus:ring-1 focus:ring-[#00A2FF] outline-none resize-none" />
                            </div>
                    ...
                    <div className="space-y-12 py-6">
                        ...
                        <div className="grid sm:grid-cols-2 gap-6">
                            <div className="p-8 bg-white border border-[#E1E7EF] rounded-[10px] space-y-4 hover:border-[#00A2FF] transition-all group">
                                ...
                                <Link href="#" className="inline-flex items-center gap-2 text-[#00A2FF] font-black text-[10px] uppercase tracking-widest pt-4 group-hover:translate-x-1 transition-transform">
                        ...
                        <div className="p-10 bg-[#0C1B33] rounded-[10px] text-white space-y-10 relative overflow-hidden shadow-2xl">
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="flex gap-6 items-start">
                                    <div className="w-10 h-10 bg-white/5 rounded-lg flex items-center justify-center text-[#00A2FF] border border-white/10 flex-shrink-0"><Mail className="h-5 w-5" /></div>
                                    <div className="space-y-1">
