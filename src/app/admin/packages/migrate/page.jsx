...
export default function MigratePricingPage() {
    ...
    const handleMigration = async () => {
        if (migrated) {
            toast.warning("Data already migrated! Check /admin/packages");
            return;
        }
                ...
                <CardContent className="space-y-6">
                    ...
                    <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                        ...
                        <ul className="text-sm text-yellow-800 space-y-1">
                            ...
                            <li>• You can edit/delete migrated packages from /admin/packages</li>
                        </ul>
                    </div>
                    ...
                    {migrated && (
                        <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                            <p className="text-sm text-green-800">
                                ...
                                <a href="/admin/packages" className="font-semibold underline">
                                    /admin/packages
                                </a>
                            </p>
                        </div>
