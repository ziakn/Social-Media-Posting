...
import CreateYoutubePost from "@/components/portal/youtube/CreatePost";
import PublishedPosts from "@/components/portal/youtube/PublishedPosts";
import ScheduledPosts from "@/components/portal/youtube/ScheduledPosts";
...
function YoutubePostsContent() {
    ...
    const handleTabChange = (value) => {
        setActiveTab(value);
        router.push(`/portal/social/youtube/posts?tab=${value}`);
    };
