...
import { Instagram, MoreVertical, ArrowRight, RefreshCcw } from "lucide-react";
import { DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuTrigger } from "@/components/ui/dropdown-menu";
import { toast } from "sonner";
import { useRouter } from "next/navigation";
import { ROUTES } from "@/constants/routes";

export default function InstagramAccountsDashboard() {
  ...
  if (accounts.length === 0)
    return (
      <div className="container mx-auto py-20 text-center max-w-xl">
        ...
        <h2 className="text-3xl font-extrabold text-neutral-800 mb-3">No Instagram Accounts Found</h2>
    ...
    <div className="container mx-auto py-10 px-4 max-w-7xl">
          ...
          >
            <CardHeader className="flex items-center justify-between pb-2">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-lg text-neutral-800 group-hover:text-neutral-900 transition-colors duration-200">
                    {account.username || account.displayName || "Instagram Account"}
                  </h3>
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  <DropdownMenuItem onClick={() => router.push(`${ROUTES.PORTAL_INSTAGRAM_POSTS}`)}>
                    Manage Posts
                  </DropdownMenuItem>
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground leading-snug">
                Manage posts, Reels, and engagement metrics from your connected Instagram account. Upload media, schedule posts, and review insights all in one place.
              </p>
            </CardContent>
            ...
            <CardFooter className="flex justify-end">
              <Button
                ...
                onClick={() => router.push(`${ROUTES.PORTAL_INSTAGRAM_POSTS}`)}
              >
                Manage Account
      ...
      <Card className="mt-12">
        <CardContent className="p-6 flex items-start gap-3">
          ...
          <div>
            <h4 className="font-semibold mb-1 text-neutral-800">Secure Instagram Integration</h4>
            <p className="text-sm text-muted-foreground leading-relaxed">
              This integration uses Instagram Graph API with OAuth 2.0. Your credentials are never stored — only access tokens are used for secure communication.
            </p>
          </div>
        </CardContent>
      </Card>
