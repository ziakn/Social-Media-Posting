                        ...
                        <div className="p-6">
                            <CardHeader className="flex flex-row items-center justify-between p-0 mb-6">
                                ...
                                <DropdownMenu>
                                    ...
                                    <DropdownMenuContent align="end" className="w-[200px] rounded-[24px] shadow-2xl border-none p-2 translate-y-2">
                                        <DropdownMenuItem onClick={() => router.push(`/portal/social/linkedin/posts`)} className="p-3 rounded-xl font-bold text-gray-700 hover:bg-gray-50">
                                            Manage Dashboard
                                        </DropdownMenuItem>
                            ...
                            <CardFooter className="p-0 flex justify-between items-center mt-auto">
                                ...
                                <Button
                                    ...
                                    onClick={() => router.push(`/portal/social/linkedin/posts`)}
                                >
                                    Dashboard
