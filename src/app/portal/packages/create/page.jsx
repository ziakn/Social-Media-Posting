...
import { createPackage } from "@/app/actions/packages/packagesActions";
...
export default function CreatePackage() {
    const [form, setForm] = useState({
        ...
        order: 0,
        isPopular: false,
        features: "", // Will use SocialCaptionEditor (plain text with line breaks)
        limits: {
            socialAccounts: 3,
            userSeats: 1,
            scheduledPosts: 30,
        ...
        <div className="p-6">
            <Card className="shadow-sm">
                <CardHeader className="flex justify-between items-center">
                    <CardTitle className="text-xl font-semibold">Add New Package</CardTitle>
                </CardHeader>
                <CardContent>
                    <form
