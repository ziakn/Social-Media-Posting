            ...
            <section className="pt-32 pb-24 bg-[#0C1B33] text-white relative overflow-hidden text-center">
                ...
                <div className="container mx-auto px-6 max-w-[1280px] relative z-10 space-y-8">
                    ...
                    <h1 className="text-5xl md:text-7xl font-extrabold font-plus-jakarta uppercase tracking-tighter leading-none mx-auto max-w-4xl">
                        ...
                        <span className="text-[#00A2FF]">Social Intelligence.</span>
                    </h1>
                ...
                <div className="container mx-auto px-6 max-w-[1280px]">
                    <div className="grid lg:grid-cols-2 gap-20 items-center">
                        <div className="space-y-8">
                            <Badge className="bg-slate-50 text-[#00A2FF] border-[#E1E7EF] uppercase tracking-[0.2em] text-[10px] px-4 py-1.5 font-black font-inter">Our Mandate</Badge>
                        ...
                        <div className="relative">
                            <div className="aspect-square bg-slate-50 rounded-[10px] border border-slate-100 flex items-center justify-center p-20 overflow-hidden group">
                                ...
                                <div className="absolute inset-0 bg-gradient-to-br from-transparent via-[#00A2FF]/5 to-transparent" />
                            </div>
                            <div className="absolute -bottom-10 -left-10 bg-white p-8 rounded-xl shadow-2xl border border-slate-100 max-w-[240px] space-y-4">
                                <div className="flex gap-1">
                                    {[1, 2, 3, 4, 5].map(i => <div key={i} className="w-1.5 h-6 bg-[#00A2FF] rounded-full animate-pulse" style={{ animationDelay: `${i * 0.2}s` }} />)}
                                </div>
            ...
            <section id="open-roles" className="py-32 bg-slate-50 border-y border-slate-100">
                <div className="container mx-auto px-6 max-w-[1280px]">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        {roles.map((role, i) => (
                            <div key={i} className="bg-white p-8 rounded-[10px] border border-slate-200 hover:border-[#00A2FF] transition-all group flex flex-col md:flex-row justify-between items-center gap-8 shadow-sm hover:shadow-subtle">
                                <div className="space-y-3 text-center md:text-left">
                                    <div className="flex items-center justify-center md:justify-start gap-4">
                                        <h3 className="text-2xl font-extrabold text-[#0C1B33] font-inter uppercase tracking-tight group-hover:text-[#00A2FF] transition-colors">{role.title}</h3>
                                        <Badge className="bg-slate-50 text-[#00A2FF] border-[#E1E7EF] font-black text-[9px] uppercase tracking-widest font-inter">{role.tag}</Badge>
                                    </div>
                                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest font-inter">{role.dept} • {role.location}</p>
                                </div>
                                <button className="w-full md:w-auto bg-[#0C1B33] text-white font-black text-[10px] uppercase tracking-[0.2em] h-12 px-8 rounded-[6px] hover:bg-[#00A2FF] transition-all font-inter">
                                    Apply Protocol
                                </button>
                            </div>
                        ))}
                    ...
                    <div className="grid md:grid-cols-3 gap-12">
                        {benefits.map((b, i) => (
                            <div key={i} className="space-y-6 group">
                                <div className="w-16 h-16 rounded-[10px] bg-slate-50 flex items-center justify-center text-[#00A2FF] border border-slate-100 group-hover:bg-[#0C1B33] group-hover:text-[#F9C80E] transition-all">
                                    {b.icon}
                                </div>
            ...
            <section className="py-32 container mx-auto px-6 max-w-[1280px]">
                <div className="bg-[#0C1B33] rounded-[10px] p-12 md:p-24 text-center text-white space-y-12 relative overflow-hidden shadow-subtle group">
                    ...
                    <h2 className="text-4xl md:text-6xl font-extrabold font-inter tracking-tighter max-w-2xl mx-auto leading-tight uppercase">
                        Don't see your <span className="text-[#00A2FF]">Protocol Node?</span>
                    </h2>
